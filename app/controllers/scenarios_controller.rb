class ScenariosController < ApplicationController
  ...
  def setup_real_scenario
    ...
    @real_balance_chart_data = Formatter.to_chart_hash(real_scenario&.balance_scenario)
  ...
  def setup_ideal_scenario
    ...
    @ideal_balance_chart_data = Formatter.to_chart_hash(ideal_scenario&.balance_scenario)
