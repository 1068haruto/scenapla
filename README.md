...
__
- 柔軟なシミュレーション
  ライフプランに合わせて、任意に支出項目を追加できるため、柔軟なシミュレーションが可能です。
- シミュレーション × ライフプラン管理
  登録したライフイベントにメモを記録でき、シミュレーションと考えの整理が１ストップで行えます。
- 将来からの逆算シミュレーション
  将来の経済状態だけでなく、現状の経済的過不足も視覚化し、キャリア形成の見直し機会も提供します。
<br>
